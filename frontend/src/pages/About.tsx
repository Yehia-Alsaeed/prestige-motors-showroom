...
const About = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-16 md:py-20">
      <section className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 items-stretch">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-[28px] border border-subtle bg-card p-5 sm:p-8 md:p-10">
          ...
          <div className="relative z-10">
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.22em] sm:tracking-[0.35em] text-gold">About Prestige Motors</p>
            <h1 className="max-w-2xl text-3xl sm:text-4xl md:text-5xl font-bold text-primary leading-tight">
              A showroom built for customers who want premium cars without a messy buying process.
            </h1>
            <p className="mt-6 max-w-2xl text-base sm:text-lg leading-7 sm:leading-8 text-secondary">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="rounded-2xl border border-subtle bg-main/50 p-4">
                <p className="text-xl sm:text-2xl font-bold text-primary">Brand New</p>
                <p className="mt-1 text-sm text-secondary">Factory-fresh inventory for direct reservation.</p>
              </div>
              <div className="rounded-2xl border border-subtle bg-main/50 p-4">
                <p className="text-xl sm:text-2xl font-bold text-primary">Used Market</p>
                <p className="mt-1 text-sm text-secondary">Verified listings with structured price negotiation.</p>
              </div>
              <div className="rounded-2xl border border-subtle bg-main/50 p-4">
                <p className="text-xl sm:text-2xl font-bold text-primary">Admin Review</p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-3">
              <Link
                to="/cars"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-gold px-5 py-3 font-bold text-main transition hover:bg-yellow-600"
              >
                Explore Showroom
                <ArrowRight size={16} />
              </Link>
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-gold/40 px-5 py-3 font-bold text-gold transition hover:bg-gold/10"
              >
                Contact Us
              </Link>
            </div>
        ...
        <div className="relative min-h-[320px] sm:min-h-[420px] overflow-hidden rounded-2xl sm:rounded-[28px] border border-gold/20 bg-main shadow-2xl shadow-gold/5">
          <img
            src={aboutHeroImage}
          ...
          <div className="absolute left-4 right-4 bottom-4 sm:left-6 sm:right-6 sm:bottom-6 rounded-2xl border border-white/10 bg-black/45 p-4 sm:p-5 backdrop-blur-sm">
            <p className="text-xs font-bold uppercase tracking-[0.22em] sm:tracking-[0.3em] text-gold">Prestige Motors</p>
            <p className="mt-2 text-base sm:text-lg font-bold text-primary">A premium showroom identity designed to feel modern, bold, and unmistakable.</p>
          </div>
        </div>
      </section>

      <section className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-2xl sm:rounded-3xl border border-subtle bg-card p-5 sm:p-7">
      ...
      <section className="mt-12 rounded-2xl sm:rounded-[28px] border border-subtle bg-card p-5 sm:p-8 md:p-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.9fr] gap-8 items-start">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.22em] sm:tracking-[0.35em] text-gold mb-4">Our Mission</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-primary mb-4 leading-tight">Make premium car buying feel direct, transparent, and worth the trust it asks for.</h2>
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-gold/20 bg-main/60 p-5 sm:p-6">
            <p className="text-sm font-bold uppercase tracking-[0.18em] sm:tracking-[0.25em] text-gold mb-4">Why Customers Choose Us</p>
