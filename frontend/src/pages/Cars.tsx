...
const Cars = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-12">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-primary mb-2">Showroom — Brand New Cars</h1>
        <p className="text-secondary text-lg">Zero-mileage vehicles. Factory fresh, ready for delivery.</p>
      </div>
      ...
      <div className="bg-card border border-subtle rounded-lg p-5 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <select value={filters.bodyType} onChange={e => setFilters({...filters, bodyType: e.target.value})} className={selectClass}>
            ...
            {['Sedan','SUV','Crossover','Hatchback','Coupe','Convertible','Fastback','Gran Coupe','Roadster','Full-size SUV','Coupe SUV','Off-road SUV'].map(t => <option key={t} value={t}>{t}</option>)}
          </select>
