const Contact = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-20">
      <div className="max-w-3xl mx-auto bg-card border border-subtle rounded-lg p-5 sm:p-10">
        <h1 className="text-3xl font-bold text-primary mb-2">Contact Us</h1>
        <p className="text-secondary mb-8 leading-7">Have a question or looking for a specific vehicle? Send us a message.</p>
        ...
        <form className="space-y-6">
          ...
          <button type="button" className="w-full sm:w-auto bg-gold text-main font-bold py-3 px-8 rounded hover:bg-yellow-600 transition">
            Send Message
          </button>
        </form>
      </div>
